...
;(function(window) {
	...
	Calendar.prototype._showContent = function(day) {
		...
		var content = contents[this.currentDayIdx],
			...
			contributor = content.querySelector('.content__contributor');
		...
		anime({
			targets: [description, meta,contributor],
			duration: 800,
    ...
    function updateDivDay() {
        var dDay = new Date().getDate();
        for (var i = dDay+1; i < 26; i++) {
            var day = document.getElementById("day"+i);
            day.setAttribute("data-inactive", "");
            day.setAttribute("data-bg-color", "#6161616");
            day.setAttribute("data-title","Coming soon...");
        }
    }
